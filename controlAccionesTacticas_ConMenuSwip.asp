        ...
        <div class="content">
     	...
     	<tr height="30%">
     		<td width="15%" height="53">&nbsp;</td>
      		<td width="55%"><input  type="button" value="Sucursales con Pendientes Vencidos" onclick="verPenVen()" name="btnEnviar" /></td>
      		<td width="30%">&nbsp;</td>
     	</tr>
     	<tr height="30%">
     		<td width="15%" height="53">&nbsp;</td>
      		<td width="55%"><input  type="button" value="Sucursales con Fotografias Faltantes" onclick="verFotPen()" name="btnEnviar" /></td>
      		<td width="30%">&nbsp;</td>
     	</tr>
		<tr height="30%">
     		<td width="15%" height="53">&nbsp;</td>
      		<td width="55%"><input  type="button" value="Sucursales sin Reporte de Obra Actualizado por el Supervisor" onclick="verSucSinAct()" name="btnEnviar" /></td>
      		<td width="30%">&nbsp;</td>
     	</tr>
    </table>
  <br/>
