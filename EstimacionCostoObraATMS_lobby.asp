...
function regresar(){
	document.getElementById('form_edicion_usuarios').action="seleccionDeAccionContratista2_lobby.asp"
...
function detSearchElemento(cajaTexto){
 ...
 function searchEstatus(partida,cr){
	$.ajax({
	type: "GET",
	url: "updateEstatusEstimacionObra_lobby.asp?partida=" + partida + "&cr=" + cr + "&estatus=" + estatus, 
	dataType: "html", 
	success: function(response){ 
	var update=response
  ...
  if(validarCampo('txt_cantidad')){
   if(validarCampoTexto('txt_unidad')){
    if(validarCampo('txt_pu')){
     if(validarCampo('txt_clavesap')){
    	
    	document.getElementById('clavesap').value=document.getElementById('txt_clavesap').value
...
function ingresarElemento(cajaTexto,zona,pu,componente){
 ...
 function detInserElemento(cajaTexto){
	$.ajax({
	type: "GET",
	url: "insertElementoEstimacionObra_lobby.asp?cr="+ document.getElementById('cr').value + "&cantidad=" + document.getElementById('unidad').value +"&sap=" + document.getElementById('sap').value + "&zona=" + document.getElementById('zona').value + "&pu=" + document.getElementById('pu').value + "&tipo=1&componente=" + document.getElementById('componente').value, 
	dataType: "html", 
	success: function(response){ 
	if (response=="ok"){
...
function detInserElementoFueraCat(){
	alert(document.getElementById('clavesap').value)
	$.ajax({
	type: "GET",
	url: "insertElementoEstimacionObra_lobby.asp?cr="+ document.getElementById('cr').value + "&cantidad=" + document.getElementById('unidad').value +"&tipo=2&pu=" + document.getElementById('pu').value + "&componente=" + document.getElementById('componente').value + "&desCorta=" + document.getElementById('desCorta').value + "&desLarga=" + document.getElementById('desLarga').value + "&und=" + document.getElementById('und').value + "&sap=" + document.getElementById('clavesap').value , 
	dataType: "html", 
	success: function(response){ 
	if (response=="ok"){
		detCargaEdicion2();
...
document.getElementById('form_edicion_usuarios').action="elementosCargadosEstimacionObra_lobby.asp"
document.getElementById('form_edicion_usuarios').submit()
}
...
<input type="hidden" name="pag" id="pag" value="atms"/>
...
<tr height="20">
 ...
 <tr height="20">
  <td><font size="+2"><strong>CR: <%=cr%> Lobby <%=buscaNombreLobby(cr)%></strong></font></td>
 </tr>
 <tr height="20">
...
<table cellpadding="0" cellspacing="0" class="display" id="example1" width="100%">
 <thead>
  ...
  <%=cargaClavesSapAtms_lobby(cr,zona,anio)%>
...
<tr height="20">
 ...
 <tr>
  <td><font size="+2" width="70%"><strong>Agregar Elemento Fuera del Catalogo Dictaminado</strong></font></td>
 </tr>
...
<tr height="20">
 ...
 <tr>
  <td><font size="+2" width="70%"><strong>Ultimos elementos agregados al Looby</strong></font></td>
