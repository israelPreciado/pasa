...
function editarUsuarios(){
	document.getElementById('frm_revisarAvance').action="archivoEstimaciones.asp"
...
function asignarGerente(){
	document.getElementById('frm_revisarAvance').action="editamails2.asp"
	document.getElementById('frm_revisarAvance').submit()
	//cambiarClase2()	
}
	...
	<table width="40%" align="center" class="animated zoomIn">
     	...
     	<tr height="30%">
     		<td width="15%" height="53">&nbsp;</td>
      		<td width="55%"><input  type="button" value="Reenvio Estimaciones" onclick="asignarGerente()" name="btnEnviar" /></td>
      		<td width="30%">&nbsp;</td>
     	</tr>
        <tr height="30%">
     		<td width="15%" height="53">&nbsp;</td>
      		<td width="55%"><input  type="button" value="Archivo Estimaciones Generadas" onclick="editarUsuarios()" name="btnEnviar" /></td>
      		<td width="30%">&nbsp;</td>
     	</tr>
    </table>
  <br/>
