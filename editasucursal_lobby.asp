 ...
 <link rel="stylesheet" href="css/tabla.css">
    ...
    <script language="javascript">
        ...
        function updatecr() {
            ...
            $.ajax({
                type: "GET",
                url: "updatesucursales_lobby.asp?cr=" + cr + "&zonap=" + zonap + "&bloque=" + bloque + "&territorial=" + territorial + "&sucursal=" + sucursal + "&alcancet=" + alcancet + "&domicilio=" + domicilio + "&colonia=" + colonia + "&m2=" + m2 + "&regional=" + regional + "&ciudad=" + ciudad + "&estado=" + estado + "&zonat=" + zonat,
                dataType: "html",
                success: function (response) {
                    if (response == "errE") {
            ...
            setTimeout("location.href='editasucursal_lobby.asp'", 1000);
...
<form  id="sucursales" name="sucursales" method="post" action="editar_detalleAlcancesLobby.asp"> 
