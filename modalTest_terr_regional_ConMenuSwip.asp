	...
	<table cellpadding="0" cellspacing="0" class="display" id="example2">
		...
		<tfoot>
			<tr>
				...
				<th  style="text-align:center;"  onclick="showDetalleAvance('<%=territorial%>',2,1,3,0,'','')" ><%=numeroSucTerrRegionalZona(territorial,query,"autorizadas",SESSION.contents("zonaDirector"))%></th>
			</tr>
		</tfoot>	
		<tbody>
<%
 ...
 <td valign="top">
	<table cellpadding="0" cellspacing="0" class="display" id="example2">
		...
		<tfoot>
			<tr>
				<th  style="text-align:center">TOTAL</th>
				<th  style="text-align:center;"  onclick="showDetalleAvance('<%=territorial%>',3,3,3,3,'','')" ><%=numeroSucTerrRegionalZona(territorial,2,"entregadas",SESSION.contents("zonaDirector"))%></th>
			</tr>
		</tfoot>	
		<tbody>
<%
 ...
 <td valign="top">
	<table cellpadding="0" cellspacing="0" class="display" id="example2">
		...
		<tfoot>
			<tr>
				<th  style="text-align:center">TOTAL</th>
				<th  style="text-align:center;"  onclick="showDetalleAvance('<%=territorial%>',3,3,3,3,'','')" ><%=numeroSucTerrRegionalZona(territorial,query,"terminadas",SESSION.contents("zonaDirector"))%></th>
			</tr>
		</tfoot>	
		<tbody>
<%
 ...
 <td valign="top">
	<table cellpadding="0" cellspacing="0" class="display" id="example2">
		...
		<tfoot>
			<tr>
				<th  style="text-align:center">TOTAL</th>
				<th  style="text-align:center;"  onclick="showDetalleAvance('<%=territorial%>',2,2,1,1,'','')" ><%=numeroSucTerrRegionalZona(territorial,query,"enProceso",SESSION.contents("zonaDirector"))%></th>
			</tr>
		</tfoot>		
		<tbody>
<%
 ...
 <td valign="top">
	<table cellpadding="0" cellspacing="0" class="display" id="example2">
		...
		<tfoot>
			<tr>
				<th  style="text-align:center">TOTAL</th>
				<th  style="text-align:center;"  onclick="showDetalleAvance('<%=territorial%>',0,0,0,0,'','')" ><%=numeroSucTerrRegionalZona(territorial,query,"porIniciar",SESSION.contents("zonaDirector"))%></th>
			</tr>
		</tfoot>	
		<tbody>
<%
