...
promedioGeneral=((promedio1*70)/100)+((promedio2*5)/100)+((promedio3*5)/100)+((promedio4*5)/100)+((promedio5*5)/100) +((promedio6*5)/100) +((promedio7*5)/100)
...
regresar=regresar & "      <td style='border:hidden' colspan='4'><p><font color='#000000'><strong>Avance General " & calculaAvanceGeneral(cr,"G") & "%</strong></font></p></td>"
