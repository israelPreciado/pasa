...
<tfoot>
   <tr>
    <th  style="text-align:center" colspan="2">TOTAL</th>
    <th  style="text-align:center;cursor:pointer" onclick="showDetalleAvance('',2,'autorizadas')"><%=numeroSupTerritorialZona(session.contents("zonaDirector"))%></th>
	<th  style="text-align:center">&nbsp;</th>
