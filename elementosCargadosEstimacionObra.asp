...
if(document.getElementById('pag').value=="atms"){
	document.getElementById('form_edicion_usuarios').action="EstimacionCostoObraATMS.asp"
	}
	else{
 document.getElementById('form_edicion_usuarios').action="EstimacionCostoObra.asp"
 }
...
function ingresarElemento(cajaTexto,zona,pu,componente){
 ...
 function detInserElemento(cajaTexto){
	$.ajax({
	type: "GET",
	url: "insertElementoEstimacionObra.asp?cr="+ document.getElementById('cr').value + "&cantidad=" + document.getElementById('unidad').value +"&sap=" + document.getElementById('sap').value + "&zona=" + document.getElementById('zona').value + "&pu=" + document.getElementById('pu').value + "&componente=" + document.getElementById('componente').value, 
	dataType: "html", 
	success: function(response){ 
	if (response=="ok"){
...
if(validarCampo(cajaTexto)){
document.getElementById('form_edicion_usuarios').action="updateElementoEstimacionObra.asp"
document.getElementById('form_edicion_usuarios').submit()
}
}
...
document.getElementById('sap').value=cajaTexto
document.getElementById('form_edicion_usuarios').action="deleteElementoEstimacionObra.asp"
document.getElementById('form_edicion_usuarios').submit()
}
