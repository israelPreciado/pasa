...
function insertPendiente(cr,pendiente,id_modulo,id_contratista){
 ...
 function back(){
	document.getElementById('frm_avanceObra').action="detalleCR_lobby.asp"
	document.getElementById('frm_avanceObra').submit()
}
...
function verDetalle(componente){
	...
	document.getElementById('hddnEnviar').value=componente
	 <%if session.Contents("privilegio")=2 then%>
	 document.getElementById('frm_avanceObra').action="verCalendarioHitos.asp"
	 <%else%>
	 if(componente=="6"||componente=="8"){
	 	document.getElementById('frm_avanceObra').action="envioEvidenciaHitos_lobby.asp"
	 }
	 else{
	 document.getElementById('frm_avanceObra').action="verCalendarioHitos.asp"
	 }
	 //document.getElementById('frm_avanceObra').action="avanceObraHitos_paso2_Contratista_lobby.asp"
  		...
  		<div id="logo">  
    		...
    		<p>
    			<table width="100%">
     				<tr>
     					<td>
     				 		<p style="font-size:38px;color:#ffffff;text-shadow: 0 0 30px #315822;"><strong><span class="icon-star-full"></span></strong></p>
     				 	</td>
     				 	<td>
     				 		<p style="font-size:38px;color:green;text-shadow: 0 0 30px #315822;"><strong><span class="icon-star-full"></span></strong></p>
     				 	</td> 
     				 	<td>
     				 		<p style="font-size:38px;color:#315822;text-shadow: 0 0 30px #315822;"><strong><span class="icon-star-full"></span></strong></p>
     				 	</td> 
     				 	<td>
     				 		<p style="font-size:38px;color:yellow;text-shadow: 0 0 30px #315822;"><strong><span class="icon-star-full"></span></strong></p>
     				 	</td> 
     				 	<td>
     				 		<p style="font-size:38px;color:red;text-shadow: 0 0 30px #315822;"><strong><span class="icon-star-full"></span></strong></p>
     				 	</td> 
     				</tr>
     				<tr>
     					<td>
     				 		<p style="font-size:28px;">Por Realizar</p>
     				 	</td>
     				 	<td>
     				 		<p style="font-size:28px;">Realizado en tiempo</p>
     				 	</td> 
     				 	<td>
     				 		<p style="font-size:28px;">Fuera de tiempo</p>
     				 	</td> 
     				 	<td>
     				 		<p style="font-size:28px;">Reprog</p>
     				 	</td> 
     				 	<td>
     				 		<p style="font-size:28px;">Vencido</p>
     				 	</td> 
     				</tr>
   				 </table>
   			</p>
...
%>
        <tr>
         ...
         <td width="50%"><p style="font-size:28px"><strong><%=rs3("modulo")%></strong></p></td>
         <td width="5%" valign="top"><p style="<%=searchSemaforoHito(rs3("id_modulo"),session.Contents("cr"))%>" ><strong><span id="semaforo_<%=rs3("id_modulo")%>"  onclick="verDetalle('<%=rs3("id_modulo")%>') "class="icon-star-full"></span></strong></p></td>
         </tr>
