...
<Script language="javascript">
 function Enviar(modulo){
	 ...
	 if(modulo==1){
	  document.getElementById('frm_modulos').action="avanceCostoObra.asp"
	 }else{
	 document.getElementById("frm_modulos").action="avanceObra4.asp"
	 }
	 <%else%>
	 	 if(modulo==1){
	  document.getElementById('frm_modulos').action="avanceCostoObra.asp"
	 }else{
	 document.getElementById("frm_modulos").action="avanceObra4Contratista.asp"
	 }
...
<%if session.Contents("privilegio")=2 then%>
<tr>
  <td align="center"><input class="botonGrande" type="button" value="Requerimiento a Terceros" onclick="menuR3ros()" name="btnEnviar"/></td>
</tr>
<%end if%> 
</table>
