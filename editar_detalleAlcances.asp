...
<%
cr=request("cr")
idTransformacion=buscaTipoTransformacion(cr)
...
<%else%>
<body onload="actualizaCantidad();document.getElementById('lblCostoAproximadoTotal').innerHTML='$' + formatNumber(<%=calculaTotalGral(cr)%>)">
<%end if%>
...
<table width='50%' align='center' cellspacing='0'>
	<h1 align='center'><font color='#991821'><strong>Revision a Detalle de Alcances</strong></font></h1>
		...
		<tr><td align="left" colspan="3"><font size="+1">&nbsp;</font></td><td align="center" colspan="2"><font size="+2"><strong>&nbsp;</strong></font><font size="+2"><strong>&nbsp;</strong></font></td>
 			...
 			<tr><td align="left" colspan="3" valign="bottom"><font size="+1"><strong>CR: <%=cargaInfoCR(cr)%></strong></font></td>
			<td align="center" colspan="3" valign="bottom"><font size="+2"><strong><%=server.HTMLEncode(buscaModulo(modulo))%></strong></font><font size="+2"><strong>&nbsp;</strong></font></td>
 			  <td colspan="2" align="right" valign="bottom" style="padding-right:5%"><font size="+2"><strong>Total</strong></font></td>
 			<td width="19%" align="right" valign="bottom"><font size="+2"><strong>
 			  <label id="lblCostoAproximado">$</label>
		  </strong></font></td></tr>
          <tr><td colspan="7"><font size="+1"><strong>SUPERVIOR ASIGNADO: <%=cargaSupervisoresId(buscaSupervisorId(cr))%></strong></font></td></tr>
          <tr><td colspan="7"><font size="+1"><strong>CONTRATISTA ASIGNADO: <%=cargaContratistasId(buscaContratista2Id(cr))%></strong></font></td></tr>
		  <tr><td width="30%"><input  type="button" value="Guardar" onclick="actualizarContratista()" name="btnEnviar"/></td></tr>
            <tr height="20px">
 ...
 <tr>
  <td><font size="+1"><strong>&nbsp;</strong></font></td></tr><tr><td><font size="+1"><strong>Tipo Transformaci&oacute;n</strong></font></td></tr><tr><td align="center"> <%=cargaTipoTransformacionSelecionada(idTransformacion)%></td>  
 </tr>
...
<script type="text/javascript"> 
   Calendar.setup({ 
    ...
    <div id='detalleAlcance' style="font:Arial, Helvetica, sans-serif;">
          <table width="100%">
            <tr>
              <td valign="top" colspan="7"><div id="barrasuperior"><table><tr><td valign="top"><font size="-1"><span>&nbsp;</span></font></td></tr></table></div></td>
            </tr>
<%
