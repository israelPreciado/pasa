...
<table align='center'><tr><td><h1><strong><%=buscaCapitulo(capitulo)%></strong></h1></td></tr></table>
...
<table cellpadding="0" cellspacing="0" class="display" id="example1">
 <thead>
  <tr bgcolor="#991821">
    ...
    <th width="60%"  height="42" align="center"><font color="#FFFFFF" size="-1">TXT BRV</font></th>
    <th width="5%"  height="42" align="center"><font color="#FFFFFF" size="-1">CANTIDAD</font></th>
    <th width="5%" height="42" align="center"><font color="#FFFFFF" size="-1">UM</font></th>
    <th width="10%"  height="42" align="left"><font color="#FFFFFF" size="-6">PRECIO BRUTO</font></th>
	<th width="10%"  height="42" align="left"><font color="#FFFFFF" size="-6">SUBTOTAL</font></th>
  </tr>
  <tfoot>
   <tr>
