...
function editarEstatusObra(){
	document.getElementById('frm_revisarAvance').action="edicion_estatusObras.asp"
	document.getElementById('frm_revisarAvance').submit()
	//cambiarClase2()	
}
	...
	<table width="40%" align="center" class="animated zoomIn">
     	...
     	<tr height="30%">
     		<td width="15%" height="53">&nbsp;</td>
      		<td width="55%"><input  type="button" value="Asignar Obra" onclick="asignarObra()" name="btnEnviar" /></td>
      		<td width="30%">&nbsp;</td>
     	</tr>
        <tr height="30%">
     		<td width="15%" height="53">&nbsp;</td>
      		<td width="55%"><input  type="button" value="Cambiar Estatus Obra" onclick="editarEstatusObra()" name="btnEnviar" /></td>
      		<td width="30%">&nbsp;</td>
     	</tr>
		 <tr height="30%">
     		<td width="15%" height="53">&nbsp;</td>
      		<td width="55%"><input  type="button" value="Editar Asignacion Obra" onclick="editarAsignar()" name="btnEnviar" /></td>
      		<td width="30%">&nbsp;</td>
     	</tr>
        <tr height="30%">
        	<td width="15%" height="53">&nbsp;</td>
