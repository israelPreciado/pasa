...
<table width='50%' align='center' cellspacing='0'>
	<h1 align='center'><font color='#991821'><strong>Alta Lobbys</strong></font></h1>
</table>
	...
	<div id="asignarObra">
		<table width="80%" align="center">
 			<tr><td>
				<div class="datagrid">
					<table>
						<thead><tr><th>CR</th><th>ZONA</th><th>TERRITORIO</th><th>NOMBRE</th></tr></thead>
						<tbody>
							<tr><td><input type='text' id='txt_cr' name='txt_cr' placeholder="ingresa CR" maxlength="5"></td><td><font color="#000000"><%=cargaZonas("0")%></font></td><td><font color="#000000"><%=cargaTerritorial("0")%></font></td><td><input type='text' id='txt_nombrelobby' name='txt_nombrelobby' placeholder="Nombre del Lobby"></font></td></tr>
						</tbody>
					</table>
                </div>    
			</td></tr>
...
function recorreElementos(div,tipoElemento){
	...
	for (var i=0; i<elemento.length; i++){
		if (elemento[i].type!="hidden" && elemento[i].name!="txt_cr"){
...
function validaFormulario(tabla){
	if (recorreElementos('asignarObra','input')){
			...
			document.getElementById('frm_revisarAvance').action="insertasignarlobby.asp"
			document.getElementById('frm_revisarAvance').submit()
				
				//	document.getElementById('frm_revisarAvance').action="editar_detalleAlcancesLobby.asp"
