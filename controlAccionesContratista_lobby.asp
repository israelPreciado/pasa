...
<div id="pagina">
  <div id="header">
   ...
   <table width="40%">
     <tr>
     <td width="10%">&nbsp;</td>
       <td width="20%"><a href="modalTest_sucursalesAsignadasContratista_lobby.asp" target = "contenido" style="text-decoration:none"><input  type="button" value="Mis Lobbys"  name="btnEnviar" /></a></td>
      <td width="10%">&nbsp;</td>
     </tr>
    </table> 
  </div>   
