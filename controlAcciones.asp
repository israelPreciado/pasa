...
<div id="pagina">
  <div id="header">
   ...
   <table width="100%">
     <tr>
     <td width="10%">&nbsp;</td>
       <td width="20%"><a href="revisar_avance.asp" target = "contenido" style="text-decoration:none"><input  type="button" value="Revisar Avances"  name="btnEnviar" /></a></td>
      <td width="10%">&nbsp;</td>
      <td width="20%"><a href="controlAcciones_asignarObra.asp" target = "contenido" style="text-decoration:none"><input  type="button" value="Administrar Obra" name="btnEnviar" /></a></td>
      <td width="10%">&nbsp;</td>
      <td width="20%"><a  href="controlAcciones_proyGral.asp" target = "contenido" style="text-decoration:none"><input type="button" value="Proyecto General" name="btnEnviar" /></a></td>
      <td width="10%">&nbsp;</td>
     </tr>
    </table> 
  </div>   
