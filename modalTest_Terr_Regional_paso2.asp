...
function showDetalleAvance(cr,modulo){
	...
	document.getElementById('frm_revisarAvance').action="modalTest_terr_regional_paso3.asp"
...
function regresar(){
	document.getElementById('frm_revisarAvance').action="modalTest_terr_regional.asp"
	document.getElementById('frm_revisarAvance').submit()
	//cambiarClase2()	
}
...
<tr>
	...
	<td  style="text-align:center"><font color="#000000"><%if rs1("avancereal") ="100" then%>Terminada <% else if rs1("avancereal") => calculaAvanceProyectado7030(rs1("cr"),rs1("fechainicio")) then %>En Tiempo<%else%>Con Atraso<%end if end if%></font></td>
