...
<%else%>     
    ...
    <br />
    <div id="detalle">
      <p>Estatus de Obra: <strong> <%if (cDbl(calculaAvanceProyectado7030(session.Contents("cr"),rs12("fechaInicio")))>cDbl(calculaAvanceGeneral(session.Contents("cr"),"G"))) then %><img src="images/indicadores/rojo_1.png"/> <%else%><img src="images/indicadores/verde.png"/> <%end if%><%=buscaEstatus(rs12("EstatusObra"))%></strong></p> 
      <table width="100%" align="center">
        <tr>
          <td><p>Proy: <strong> <%=calculaAvanceProyectado7030(session.Contents("cr"),rs12("fechaInicio"))%> % </strong></p></td>
