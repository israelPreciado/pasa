...
function altaLobby(){
document.getElementById('frm_revisarAvance').action="asignarLobby.asp"
document.getElementById('frm_revisarAvance').submit()
}
...
function editarLobby(){
 if (document.getElementById('id_lobby').value==""){
	simulateClick(document.getElementById('alert'))
 }
 else{
	document.getElementById('frm_revisarAvance').action="cargadetalleAlcancesLobby.asp"
	document.getElementById('frm_revisarAvance').submit()
 }
}
</script>
	...
	<table width="40%" align="center" class="animated zoomIn">
     	...
     	<tr height="30%">
     		<td width="15%" height="53">&nbsp;</td>
      		<td width="55%"><input  type="button" value="Alta Lobby" onclick="altaLobby()" name="btnEnviar" /></td>
      		<td width="30%">&nbsp;</td>
     	</tr>
		<tr height="30%">
     		<td width="15%" height="53">&nbsp;</td>
      		<td width="55%"><input  type="button" value="Editar Lobby" onclick="editarLobby()" name="btnEnviar" /></td>
      		<td width="30%">&nbsp;</td>
     	</tr>
       <tr height="30%">
          <td width="15%" height="53">&nbsp;</td>
...
<script>
		...
		$("#alert").on( 'click', function () {
			reset();
			alertify.alert("Debes elegir un LOBBY" );
			return false;
		});
