...
function addUser(){
 ...
 function deleteUser(id){
	document.getElementById('form_edicion_usuarios').action='deleteGerente.asp'
...
<table cellpadding="0" cellspacing="0" class="display" id="example1">
 <thead>
  <tr bgcolor="#991821">
	<th width="64"  height="42" align="center"><font color="#FFFFFF" size="-1">GERENTE</font></th>
    <th width="102" height="42" align="center"><font color="#FFFFFF" size="-1">SUPERVISOR</font></th>
    <th width="59"  height="42" align="left"><font color="#FFFFFF" size="-6">ELIMINAR</font></th>
  </tr>
 </thead> 
 
  <%=cargaGerentesSupervisores%>
...
<script>
  ...
  $("#ok").on( 'click', function () {
		...
		$("#confirmDelete").on( 'click', function () {
			reset();
			alertify.confirm("¿ESTAS SEGURO DE ELIMINAR LA ASIGNACION DE ESTE SUPERVISOR, ESTA ACCION NO SE PUEDE REVERTIR?", function (e) {
				if (e) {
