...
%>
		...
		<table width="80%" style="padding-top:10%;display:none" id="tabla_Album" align="center">
			<tr>
				<td><em><font size="+6"><strong>Estamos trabajando en esta Area</strong></font></em></td>
			</tr>
		</table>
		<table width="80%" style="padding-top:10%;display:none" id="tabla_Album" align="center">
			<tr>
