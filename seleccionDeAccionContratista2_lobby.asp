...
function editarUsuarios(){
  document.getElementById('anio').value="2017"
	document.getElementById('frm_revisarAvance').action="EstimacionCostoObraAtms_lobby.asp"
	document.getElementById('frm_revisarAvance').submit()
	//cambiarClase2()	
}
function editarUsuarios2(){
...
function asignarGerente(){
	document.getElementById('anio').value="2017"
	document.getElementById('frm_revisarAvance').action="EstimacionCostoObra_lobby.asp"
	document.getElementById('frm_revisarAvance').submit()
	//cambiarClase2()	
}
...
<body>
<form name="frm_revisarAvance" id="frm_revisarAvance">
	...
	<table width="40%" align="center" class="animated zoomIn">
     	...
     	<tr height="30%">
     		<td width="15%" height="53">&nbsp;</td>
      		<td width="55%"><input  type="button" value="Alta Obra Civil Cat.2017<%=zona%>" onclick="asignarGerente()" name="btnEnviar" /></td>
      		<td width="30%">&nbsp;</td>
     	</tr>
		<tr height="30%">
     		<td width="15%" height="53">&nbsp;</td>
