...
function editarAsignar(){
 if (document.getElementById('cr').value==""){
	...
	document.getElementById('frm_revisarAvance').action="edicion_llegadamateriales.asp"
	document.getElementById('frm_revisarAvance').submit()
 }
}
</script>
	...
	<table width="40%" align="center" class="animated zoomIn">
		 <tr height="30%">
     		<td width="15%" height="53">&nbsp;</td>
      		<td width="55%"><input  type="button" value="Editar Suministros" onclick="editarAsignar()" name="btnEnviar" /></td>
      		<td width="30%">&nbsp;</td>
     	</tr>
        <tr height="30%">
        	<td width="15%" height="53">&nbsp;</td>
