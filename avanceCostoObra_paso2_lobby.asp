...
function insertPendiente(cr,pendiente,id_modulo,id_contratista){
 ...
 function back(){
	document.getElementById('frm_avanceObra').action="avanceCostoObra_lobby.asp"
	document.getElementById('frm_avanceObra').submit()
}
...
function detSearchCostoEstimadSucursal(){
	...
	$.ajax({
	type: "GET",
	url: "searchCostoEstimado_lobby.asp?cr=" + document.getElementById('cr').value, 
	dataType: "html", 
	success: function(response){ 
...
function detSearchCostoEstimadPartida(){
	...
	$.ajax({
	type: "GET",
	url: "searchCostoEstimadoPartida_lobby.asp?cr=" + document.getElementById('cr').value + "&componente=" + document.getElementById('componente').value , 
	dataType: "html", 
	success: function(response){ 
...
function detSearchCostoExcesoPorPartida(){
	...
	$.ajax({
	type: "GET",
	url: "SearchCostoExcesoPorPartida_lobby.asp?cr=" + document.getElementById('cr').value + "&componente=" + document.getElementById('componente').value , 
	dataType: "html", 
	success: function(response){ 
...
function detSearchCostoEstimaoPorPartida(){
	...
	$.ajax({
	type: "GET",
	url: "searchCostoEstimadoPorPartida_lobby.asp?cr=" + document.getElementById('cr').value + "&componente=" + document.getElementById('componente').value , 
	dataType: "html", 
	success: function(response){ 
...
function detSearchCostoEstimado(id){
	$.ajax({
	type: "GET",
	url: "searchDetalleClaveSap_AvanceCostoObra_lobby.asp?id=" + id, 
	dataType: "html", 
	success: function(response){ 
...
function detSearchAvanceElemento(id){
	$.ajax({
	type: "GET",
	url: "searchAvanceElemento_lobby.asp?id=" + id, 
	dataType: "html", 
	success: function(response){ 
...
function detSearchAvanceElementoContratista(id){
	$.ajax({
	type: "GET",
	url: "searchAvanceElementoContratista_lobby.asp?id=" + id, 
	dataType: "html", 
	success: function(response){ 
...
function detSearchElementoCerrado(id){
	$.ajax({
	type: "GET",
	url: "searchElementoCerrado_lobby.asp?id=" + id, 
	dataType: "html", 
	success: function(response){ 
	if (response=="1") {
		simulateClick(document.getElementById('alert3'))
...
function detUpdateCantidad(id,cantidad){
	$.ajax({
	type: "GET",
	url: "updateCantidadAvanceCostoEstimado_lobby.asp?id=" + id + "&cantidad=" + cantidad + "&cr=" + document.getElementById("cr").value, 
	dataType: "html", 
	success: function(response){ 
	var update=response
	//$("#dedede").html(response);
...
function detUpdateCantidadContratista(id,cantidad){
	$.ajax({
	type: "GET",
	url: "updateCantidadAvanceCostoEstimadoContratista_lobby.asp?id=" + id + "&cantidad=" + cantidad + "&cr=" + document.getElementById("cr").value, 
	dataType: "html", 
	success: function(response){ 
	var update=response
	//$("#dedede").html(response);
...
//alert(id)
	$.ajax({
	type: "GET",
	url: "updateCerrarConcepto_lobby.asp?id=" + id, 
	dataType: "html", 
	success: function(response){ 
	var update=response
	//$("#dedede").html(response);
...
sql4= "select id,CLAVE_SAP_CONCURSO,clave_sap_zona,descorta as descripcion_corta,deslarga as descripcion_larga,pu,cantidad,und,cantidad * pu as estimacion,componente,fecha_ingreso, avance,round(avanceContratista,2) as avanceContratista,case when avanceCompletado =1 then 'rojo' when avanceCompletado is null and avance is null then 'verde' else 'amarillo' end as color, avanceCompletado from nuevocosto_estimadoobra_lobby where componente = '" & componente &"' and cr='" & session.Contents("cr") &"'  order by CLAVE_SAP_CONCURSO desc;"
...
sql4= "select a.id,a.CLAVE_SAP_CONCURSO,a.clave_sap_zona,b.DESCRIPCION_CORTA,b.DESCRIPCION_LARGA,a.pu,a.cantidad,b.und,a.cantidad * a.pu as estimacion,a.componente,a.fecha_ingreso, avance,round(avanceContratista,2) as avanceContratista,case when avanceCompletado =1 then 'rojo' when avanceCompletado is null and avance is null then 'verde' else 'amarillo' end as color, avanceCompletado from nuevocosto_estimadoobra_lobby a LEFT JOIN cat_sap_atms_2017 b on a.CLAVE_SAP_CONCURSO=b.CLAVE_SAP_CONCURSO where a.componente = '" & componente &"' and cr='" & session.Contents("cr") &"' order by CLAVE_SAP_CONCURSO desc; "
...
sql4= "select a.id,a.CLAVE_SAP_CONCURSO,a.clave_sap_zona,b.DESCRIPCION_CORTA,b.DESCRIPCION_LARGA,a.pu,a.cantidad,b.und,a.cantidad * a.pu as estimacion,a.componente,a.fecha_ingreso, avance,round(avanceContratista,2) as avanceContratista,case when avanceCompletado =1 then 'rojo' when avanceCompletado is null and avance is null then 'verde' else 'amarillo' end as color, avanceCompletado from nuevocosto_estimadoobra_lobby a LEFT JOIN cat_sap_2017 b on a.CLAVE_SAP_CONCURSO=b.CLAVE_SAP_CONCURSO where a.componente = '" & componente &"' and cr='" & session.Contents("cr") &"' order by CLAVE_SAP_CONCURSO desc; "
...
conn3.open connstr
if componente="Otros" then
sql4= "select id,CLAVE_SAP_CONCURSO,clave_sap_zona,descorta as DESCRIPCION_CORTA,deslarga as DESCRIPCION_LARGA,pu,cantidad,und,cantidad * pu as estimacion,componente,fecha_ingreso, avance,case when avanceContratista is null then avanceContratista else round(avanceContratista,2) end as avanceContratista,case when avanceCompletado =1 then 'rojo' when avanceCompletado is null and avance is null then 'verde' else 'amarillo' end as color, avanceCompletado from nuevocosto_estimadoobra_lobby where componente = '" & componente &"' and cr='" & session.Contents("cr") &"' order by CLAVE_SAP_CONCURSO desc;"
else
if componente="ATMS" then
sql4= "select a.id,a.CLAVE_SAP_CONCURSO,a.clave_sap_zona,b.DESCRIPCION_CORTA,b.DESCRIPCION_LARGA,a.pu,a.cantidad,b.und,a.cantidad * a.pu as estimacion,a.componente,a.fecha_ingreso, avance,case when avanceContratista is null then avanceContratista else round(avanceContratista,2) end as avanceContratista,case when avanceCompletado =1 then 'rojo' when avanceCompletado is null and avance is null then 'verde' else 'amarillo' end as color, avanceCompletado  from nuevocosto_estimadoobra_lobby a LEFT JOIN cat_sap_atms_2017 b on a.CLAVE_SAP_CONCURSO=b.CLAVE_SAP_CONCURSO where a.componente = '" & componente &"' and cr='" & session.Contents("cr") &"' order by CLAVE_SAP_CONCURSO desc; "
else
sql4= "select a.id,a.CLAVE_SAP_CONCURSO,a.clave_sap_zona,b.DESCRIPCION_CORTA,b.DESCRIPCION_LARGA,a.pu,a.cantidad,b.und,a.cantidad * a.pu as estimacion,a.componente,a.fecha_ingreso, avance,case when avanceContratista is null then avanceContratista else round(avanceContratista,2) end as avanceContratista,case when avanceCompletado =1 then 'rojo' when avanceCompletado is null and avance is null then 'verde' else 'amarillo' end as color, avanceCompletado  from nuevocosto_estimadoobra_lobby a LEFT JOIN cat_sap_2017 b on a.CLAVE_SAP_CONCURSO=b.CLAVE_SAP_CONCURSO where a.componente = '" & componente &"' and cr='" & session.Contents("cr") &"' order by CLAVE_SAP_CONCURSO desc; "
end if
end if
