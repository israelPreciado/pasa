...
fechaProgramada=buscaFechaProgramadaLobby(session.Contents("cr"))
%>
  		...
  		<div align="center" id="menu_inicio">
    		<div id="detalle">
    			<table width="100%">
     				...
     				<tr>
     				 	<td width="70%"><p>HITO: <strong><%=nombreModulo%></strong></p></td>    
     				</tr>
     				<tr>
     				 	<td width="70%"><p>Fecha Programada de Termino: <strong><%=fechaProgramada%></strong></p></td>    
     				</tr>
   				 </table>
    		</div>
    	</div>
...
<table width="90%" align="center" style="padding-left:5%">
        ...
        <tr>
         ...
         <tr height="12px">
          <td colspan="3"><input type="date" name="fecha_termino_real"></td>
         </tr>
