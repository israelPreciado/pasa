...
function confirmar_reprogramarUser(id) {
	document.getElementById('temp1').value=id
	document.getElementById('form_edicion_usuarios').action='edicion_estatusObras_Reprogramar.asp'
	document.getElementById('form_edicion_usuarios').submit()
}
...
function actualizar(id){
	if(document.getElementById('parrafo_'+id).innerText=="Suspendida"){
		if(validar2('txt_'+id)){
			...
			document.getElementById('form_edicion_usuarios').action='updateEstatusObra.asp'
			document.getElementById('form_edicion_usuarios').submit()
		}
	}
	else{
...
<table cellpadding="0" cellspacing="0" class="display" id="example1">
 <thead>
  <tr bgcolor="#991821">
	...
	<th width="48"  height="42" align="center"><font color="#FFFFFF" size="-1">ESTATUS</font></th>
  ...
  <%=cargaSucursales_edicionEstatus%>
