...
function regresar(){
	document.getElementById('frm_revisarAvance').action="controlAcciones_asignarObra.asp"
 			...
 			<tr><td>
				<div class="datagrid">
					<table>
						...
						<tbody>
							<tr><td><font color="#000000"><%=cargaCRs()%></font></td><td><font color="#000000"><%=cargaTipoTransformacion()%></font></td><td><font color="#000000"><%=cargaContratistas()%></font></td><td><font color="#000000"><%=cargaSupervisores()%></font></td></tr>
						</tbody>
					</table>
                </div>    
			</td></tr>
