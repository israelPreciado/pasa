...
regresar=""
'sql12="update tseguimiento set fechaPrimVisita='" & fecha & "' where cr='"& cr &"';"

'ejecutamos la consulta

'conn12.execute sql12

sql13="insert into cat_pedimentos (prefijo,cr,pedimento) values ('O-TR18-001-OC/','" & cr &"','"&pedimento &"' )"
