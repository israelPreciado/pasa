...
%>
		{
			...
			title: "<%=rs1("material")%>",
			description: "<p>Cantidad: <%=rs1("cantidad")%></p><p>Comentario: <%=rs1("comentario")%></p><p>Tiempo: <%=rs1("tiempo")%> semanas</p><p>Pos: <%=rs1("pos")%></p><p>Clave Sap: <%=rs1("cve_sap")%></p><!--<p><button type='button' class='botonChico' onclick='obtenerFecha(<%=rs1("id_pedido")%>)' style='display:block'><font style='font-size:50%;color:white'><span class='icon-pencil2'></span></font></button></p>-->",
...
<table  width="80%" align="center">
	<tr>
		<!--<td align="center"><input class="botonGrande" type="button" value="Agregar Evento" onclick='obtenerFecha()' name="btnEnviar"/></td>-->
