...
<div id="pagina">
  <div id="header">
    ...
    <table><tr><td width="85%" <%if session.Contents("privilegio")=2 then%>onclick="home()"<%else%>onclick="home2()"<%end if%>><a href="#" style="padding-left:75%;color:white;"><font style="font-size:200%"><span class="icon-home3"></span></font></a></td><td onclick="exit()"><a href="#" style="padding-left:50%;color:white;"><font style="font-size:200%"><span class="icon-exit"></span></font></a></td></tr></table>
      &nbsp;
    </div>
  </div>
...
<%if session.Contents("privilegio")=2 then%>
      <table  width="80%" align="center">
        ...
        <tr>
          <td align="center"><input class="botonGrande" type="button" value="Detalle Costo Obra" onclick="validar6()" name="btnEnviar"/></td>
        </tr>
        <tr height="20px">
          <td>&nbsp;</td>
        </tr>
        ...
        <tr>
          <td align="center"><input class="botonGrande" type="button" value="Generar Estimacion" onclick="validar7()" name="btnEnviar"/></td>
        </tr>
        <tr height="20px">
          <td>&nbsp;</td>
        </tr>
        ...
        <tr>
          <td align="center"><input class="botonGrande" type="button" value="Registrar Pedimento" onclick="validar9()" name="btnEnviar"/></td>
        </tr>
        <tr height="20px">
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td align="center"><input class="botonGrande" type="button" value="Suc. Entregada a Mtto." onclick="validar8()" name="btnEnviar"/></td>
        </tr>
        <tr height="20px">
          <td>&nbsp;</td>
        </tr>
