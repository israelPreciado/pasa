...
function showDetalleAvance(cr,modulo){
	...
	document.getElementById('frm_revisarAvance').action="modalTest_terr_contratista_paso3.asp"
...
function regresar(){
	document.getElementById('frm_revisarAvance').action="modalTest_terr_contratistas.asp"
	document.getElementById('frm_revisarAvance').submit()
	//cambiarClase2()	
}
