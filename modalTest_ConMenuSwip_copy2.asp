...
<thead><tr><th>&nbsp;</th><th>CRss</th><th>Sucursal</th><th>Contratista</th><th>Supervisor</th><th>Fecha Inicio</th><th>Estatus</th><%if estatus1 =0 and estatus2 =0 then%><th>Obs.</th><%end if%><th>Costo Estimado</th></tr></thead>
