...
function verDetalle(territorial){
...
<%
zona_territorial=session.contents("zonaDirector")
%>
<%
...
'sql1= "SELECT *, round( 100 - ifnull((( ifnull(presupuesto, 0) - ifnull(costoReal, 0)) * 100 / presupuesto), 0), 2) AS Desviacion FROM( SELECT a.regional, round(ifnull(b.total,0),2) AS estimacion1, round(ifnull(c.total,0),2) AS estimacion2, round(ifnull(d.total,0),2) AS estimacion3, round(ifnull(b.total,0)+ ifnull(c.total,0) + ifnull(d.total,0),2) AS costoReal, round(ifnull(e.total, 0),2) AS presupuesto FROM( SELECT regional FROM cat_sucursales WHERE zona_territorial =" & zona_territorial & " GROUP BY regional) a LEFT JOIN( SELECT sum(totalestimacion) AS total, regional FROM( SELECT a.*, pu * avance AS totalEstimacion, b.regional, concat( ifnull(a.cr, '0000'), ifnull( clave_sap_concurso, '000000000'), ifnull(clave_sap_zona, '00000000'), cantidad, pu) AS nid FROM estimacion1 a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE b.zona_territorial =" & zona_territorial & " GROUP BY concat( ifnull(a.cr, '0000'), ifnull( clave_sap_concurso, '000000000'), ifnull(clave_sap_zona, '00000000'), cantidad, pu)) a GROUP BY regional) b ON a.regional = b.regional LEFT JOIN( SELECT sum(totalestimacion) AS total, regional FROM( SELECT a.*, pu * avance AS totalEstimacion, b.regional, concat( ifnull(a.cr, '0000'), ifnull( clave_sap_concurso, '000000000'), ifnull(clave_sap_zona, '00000000'), cantidad, pu) AS nid FROM estimacion2 a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE b.zona_territorial =" & zona_territorial & " GROUP BY concat( ifnull(a.cr, '0000'), ifnull( clave_sap_concurso, '000000000'), ifnull(clave_sap_zona, '00000000'), cantidad, pu)) a GROUP BY regional) c ON a.regional = c.regional LEFT JOIN( SELECT sum(totalestimacion) AS total, regional FROM( SELECT a.*, pu * avance AS totalEstimacion, b.regional, concat( ifnull(a.cr, '0000'), ifnull( clave_sap_concurso, '000000000'), ifnull(clave_sap_zona, '00000000'), cantidad, pu) AS nid FROM estimacion3 a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE b.zona_territorial =" & zona_territorial & " GROUP BY concat( ifnull(a.cr, '0000'), ifnull( clave_sap_concurso, '000000000'), ifnull(clave_sap_zona, '00000000'), cantidad, pu)) a GROUP BY regional) d ON a.regional = d.regional LEFT JOIN( SELECT sum(total) AS total, regional FROM( SELECT sum(cantidad * pu) total, regional FROM( SELECT a.*, concat( ifnull(a.cr, '0000'), ifnull( clave_sap_concurso, '000000000'), ifnull(clave_sap_zona, '00000000'), cantidad, pu, CASE WHEN componente = 'otros' THEN descorta ELSE '' END) AS nid, b.Regional FROM nuevocosto_estimadoobra a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE b.zona_territorial =" & zona_territorial & ") a GROUP BY nid DESC) a GROUP BY regional) e ON a.regional = e.regional) a WHERE presupuesto > 0"
sql1="SELECT *, round( 100 - ifnull((( ifnull(presupuesto, 0) - ifnull(costoReal, 0)) * 100 / presupuesto), 0), 2) AS Desviacion FROM( SELECT a.territorial, round(ifnull(b.total, 0), 2) AS estimacion1, round(ifnull(c.total, 0), 2) AS estimacion2, round(ifnull(d.total, 0), 2) AS estimacion3, round( ifnull(b.total, 0) + ifnull(c.total, 0) + ifnull(d.total, 0), 2) AS costoReal, round(ifnull(e.total, 0), 2) AS presupuesto FROM( SELECT territorial FROM cat_sucursales WHERE zona_territorial = " & zona_territorial & " GROUP BY territorial) a LEFT JOIN( SELECT sum(totalestimacion) AS total, territorial FROM( SELECT a.*, pu * avance AS totalEstimacion, b.territorial, concat( ifnull(a.cr, '0000'), ifnull( clave_sap_concurso, '000000000'), ifnull(clave_sap_zona, '00000000'), cantidad, pu) AS nid FROM estimacion1 a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE b.zona_territorial = " & zona_territorial & " GROUP BY concat( ifnull(a.cr, '0000'), ifnull( clave_sap_concurso, '000000000'), ifnull(clave_sap_zona, '00000000'), cantidad, pu)) a GROUP BY territorial) b ON a.territorial = b.territorial LEFT JOIN( SELECT sum(totalestimacion) AS total, territorial FROM( SELECT a.*, pu * avance AS totalEstimacion, b.territorial, concat( ifnull(a.cr, '0000'), ifnull( clave_sap_concurso, '000000000'), ifnull(clave_sap_zona, '00000000'), cantidad, pu) AS nid FROM estimacion2 a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE b.zona_territorial = " & zona_territorial & " GROUP BY concat( ifnull(a.cr, '0000'), ifnull( clave_sap_concurso, '000000000'), ifnull(clave_sap_zona, '00000000'), cantidad, pu)) a GROUP BY territorial) c ON a.territorial = c.territorial LEFT JOIN( SELECT sum(totalestimacion) AS total, territorial FROM( SELECT a.*, pu * avance AS totalEstimacion, b.territorial, concat( ifnull(a.cr, '0000'), ifnull( clave_sap_concurso, '000000000'), ifnull(clave_sap_zona, '00000000'), cantidad, pu) AS nid FROM estimacion3 a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE b.zona_territorial = " & zona_territorial & " GROUP BY concat( ifnull(a.cr, '0000'), ifnull( clave_sap_concurso, '000000000'), ifnull(clave_sap_zona, '00000000'), cantidad, pu)) a GROUP BY territorial) d ON a.territorial = d.territorial LEFT JOIN( SELECT sum(total) AS total, territorial FROM( SELECT sum(cantidad * pu) total, territorial FROM( SELECT a.*, concat( ifnull(a.cr, '0000'), ifnull( clave_sap_concurso, '000000000'), ifnull(clave_sap_zona, '00000000'), cantidad, pu, CASE WHEN componente = 'otros' THEN descorta ELSE '' END) AS nid, b.territorial FROM nuevocosto_estimadoobra a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE b.zona_territorial = " & zona_territorial & ") a GROUP BY nid DESC) a GROUP BY territorial) e ON a.territorial = e.territorial) a WHERE presupuesto > 0"
...
%>
 <tr>
  <td align="center" onclick="verDetalle('<%=rs1("territorial")%>')"><font size="+2" color="red"><span class="icon-search"></span></font></td>
