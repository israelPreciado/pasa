...
%>
 ...
 <tr>
  <td align="center">
				...
				<section>
<div>
  <input type="radio" id="control_E<%=rs("id_pregunta")%>" name="cond_<%=rs("id_pregunta")%>" value="1" onchange="showComentarios('divComentarios_<%=rs("id_pregunta")%>',1)">
  <label for="control_E<%=rs("id_pregunta")%>">
    <h2>Excelente</h2>
  </label>
</div>
<div>
  <input type="radio" id="control_B<%=rs("id_pregunta")%>" name="cond_<%=rs("id_pregunta")%>" value="2" onchange="showComentarios('divComentarios_<%=rs("id_pregunta")%>',2)">
  <label for="control_B<%=rs("id_pregunta")%>">
    <h2>Bueno</h2>
  </label>
</div>
<div>
  <input type="radio" id="control_R<%=rs("id_pregunta")%>" name="cond_<%=rs("id_pregunta")%>" value="3" onchange="showComentarios('divComentarios_<%=rs("id_pregunta")%>',3)">
  <label for="control_R<%=rs("id_pregunta")%>">
    <h2>Regular</h2>
  </label>
</div>
<div>
  <input type="radio" id="control_M<%=rs("id_pregunta")%>" name="cond_<%=rs("id_pregunta")%>" value="4" onchange="showComentarios('divComentarios_<%=rs("id_pregunta")%>',4)">
 ...
 <tr height="80px">
  <td> <section>
<div id="divComentarios_<%=rs("id_pregunta")%>" style="display:none">
  <input type="text" id="comentarios_<%=rs("pregunta")%>" name="comentarios_<%=rs("id_pregunta")%>" placeholder="Observaciones" maxlength="40">
</div>
</section></td>
 </tr>
