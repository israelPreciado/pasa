...
function showDetalleAvance(cr,modulo){
	...
	document.getElementById('frm_revisarAvance').action="modalTest_terr_contratista_paso3_ConMenuSwip.asp"
...
<thead>
	<tr>
		...
		<th width="18%" colspan="3">% Avance Real</th>
...
if contratista="" then
 if mes="" then 
  if territorial="" then
   sql1="SELECT a.cr, a.Sucursal, b.login_nombre, a.AvanceReal, a.obra_civil, a.viniles, a.atms, a.seguridad, a.suministros, a.senalizacionExt, a.SistemasInst, a.supervisorAsignado,a.fechainicio,ifnull(a.aa,0) as aa FROM tseguimiento a LEFT JOIN app_bnrt_login b ON a.supervisorAsignado = b.login_id WHERE LEFT(a.FechaInicio, 4) = '" & anio & "'"
  else
   sql1="SELECT a.cr, a.Sucursal, b.login_nombre, a.AvanceReal, a.obra_civil, a.viniles, a.atms, a.seguridad, a.suministros, a.senalizacionExt, a.SistemasInst, a.supervisorAsignado,a.fechainicio,ifnull(a.aa,0) as aa FROM tseguimiento a LEFT JOIN app_bnrt_login b ON a.supervisorAsignado = b.login_id LEFT JOIN cat_sucursales c on a.cr=c.cr WHERE LEFT(a.FechaInicio, 4) = '" & anio & "' and c.Territorial='" & territorial & "'"
  end if
 else
  if territorial="" then
 ...
 if mes="" then
  sql1="SELECT a.cr, a.Sucursal, b.login_nombre, a.AvanceReal, a.obra_civil, a.viniles, a.atms, a.seguridad, a.suministros, a.senalizacionExt, a.SistemasInst, a.supervisorAsignado,a.fechainicio,ifnull(a.aa,0) as aa FROM tseguimiento a LEFT JOIN app_bnrt_login b ON a.supervisorAsignado = b.login_id WHERE contratistaAsignado = '" & contratista & "' AND LEFT(a.FechaInicio, 4) = '" & anio & "'"
 else
  sql1="SELECT a.cr, a.Sucursal, b.login_nombre, a.AvanceReal, a.obra_civil, a.viniles, a.atms, a.seguridad, a.suministros, a.senalizacionExt, a.SistemasInst, a.supervisorAsignado,a.fechainicio,ifnull(a.aa,0) as aa FROM tseguimiento a LEFT JOIN app_bnrt_login b ON a.supervisorAsignado = b.login_id WHERE contratistaAsignado = '" & contratista & "' AND LEFT(a.FechaInicio, 4) = '" & anio & "' AND RIGHT(LEFT(a.FechaInicio, 7), 2) = '" & mes & "'"
 end if
end if
...
<tr>
 ...
 <td align="center"><font color="#000000"><%=rs1("cr")%></font></td><td  style="text-align:center"><font color="#000000"><%=rs1("sucursal")%></font></td>
 ...
 <td  style="text-align:center;" onclick="showDetalleAvance('<%=rs1("cr")%>',1)"><font color="#000000"><%=round(rs1("obra_civil"),2)%> %</font></td>
...
if contratista="" then
 ...
 if mes="" then
  sql1="SELECT a.cr, a.Sucursal, b.login_nombre, a.AvanceReal, a.obra_civil, a.viniles, a.atms, a.seguridad, a.suministros, a.senalizacionExt, a.SistemasInst, a.supervisorAsignado,a.fechainicio,ifnull(a.aa,0) as aa FROM tseguimiento a LEFT JOIN app_bnrt_login b ON a.supervisorAsignado = b.login_id LEFT JOIN cat_sucursales c on a.cr=c.cr WHERE contratistaAsignado = '" & contratista & "' AND LEFT(a.FechaInicio, 4) = '" & anio & "' and c.zona_territorial='" & session.contents("zonaDirector") & "'"
 else
  sql1="SELECT a.cr, a.Sucursal, b.login_nombre, a.AvanceReal, a.obra_civil, a.viniles, a.atms, a.seguridad, a.suministros, a.senalizacionExt, a.SistemasInst, a.supervisorAsignado,a.fechainicio,ifnull(a.aa,0) as aa FROM tseguimiento a LEFT JOIN app_bnrt_login b ON a.supervisorAsignado = b.login_id LEFT JOIN cat_sucursales c on a.cr=c.cr WHERE contratistaAsignado = '" & contratista & "' AND LEFT(a.FechaInicio, 4) = '" & anio & "' AND RIGHT(LEFT(a.FechaInicio, 7), 2) = '" & mes & "' and c.zona_territorial='" & session.contents("zonaDirector") & "'"
 end if
end if
