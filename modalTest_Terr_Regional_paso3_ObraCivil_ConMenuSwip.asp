...
Conn.Open connstr
sql= "select * from nuevocosto_estimadoobra  where cr='" & cr &"' GROUP BY componente"
rs.open sql,conn
if rs.eof then
%> 
	<tr>
...
%>
	...
	<tr>
	  ...
	  <td width="20%"><p>NA</p></td>
      <td><p id="parrafo<%=rs("componente")%>"><%=costoEstimadoPorPartida(cr,rs("componente"))%></p></td> 
