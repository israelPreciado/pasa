...
<head>
    ...
    <script language="javascript">
        ...
        function prueba() {
            ...
            $.ajax({
                type: "GET",
                url: "insertasuc_lobby.asp?cr=" + cr + "&zonap=" + zonap + "&bloque=" + bloque + "&territorial=" + territorial + "&sucursal=" + sucursal + "&alcancet=" + alcancet + "&inicio=" + inicio + "&fin=" + fin + "&domicilio=" + domicilio + "&colonia=" + colonia + "&m2=" + m2 + "&regional=" + regional + "&ciudad=" + ciudad + "&estado=" + estado + "&zonat=" + zonat,
                dataType: "html",
...
<div class="datagrid" id="tabla_cr">
    <table  align='center' cellpadding='0' class='display' id='example2'>
        ...
        <tr>
            <td> CR * </td>
            <td><input type="text" id="cr" name="cr" onkeypress="return soloNumeros(event)" maxlength="5" placeholder="ej. 00003" /></td>
     ...
     <tr>
          <td> Tipo de Inmueble </td><td><input type="text" name="m2" id="m2" /></td>
