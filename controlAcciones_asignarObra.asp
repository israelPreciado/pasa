...
function editarUsuarios(){
	document.getElementById('frm_revisarAvance').action="controlAcciones_adminUsuarios.asp"
...
function adminSucur(){
	document.getElementById('frm_revisarAvance').action="gestionsucursales.asp"
	document.getElementById('frm_revisarAvance').submit()
	//cambiarClase2()	
}
...
<form name="frm_revisarAvance" id="frm_revisarAvance" method="post">
	...
	<table width="40%" align="center" class="animated zoomIn">
		...
		<tr height="30%">
     		<td width="15%" height="53">&nbsp;</td>
      		<td width="55%"><input  type="button" value="Administrar Sucursales" onclick="adminSucur()" name="btnEnviar" /></td>
      		<td width="30%">&nbsp;</td>
     	</tr>
		<tr height="30%">
     		<td width="15%" height="53">&nbsp;</td>
