...
function guardaFoto(){
		...
		if(document.getElementById('fileFotografia1').value=="" || document.getElementById('fileFotografia2').value==""){
			simulateClick(document.getElementById('alert3'))
				...
				document.getElementById('frm_modulos').action="envioEvidenciaHitos_guardaFoto_lobby.asp"
				document.getElementById('frm_modulos').submit()
			}
...
<br/>
				  ...
				  <div id="detalle">
<p style="font-size:150%"><font color="blue">Ingresa el correo a donde llegara la evidencia</font></p>
...
<p style="font-size:150%"><font color="blue">Agrega una foto de la evidencia </font></p>  	  	  
 </div>
