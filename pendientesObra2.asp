...
conn3.open connstr
sql3= "select * from pendientes a where id_modulo='" & modulo & "' and cr=" & session.Contents("cr")
rs2.open sql3, conn3
if rs2.eof then
	rs2.close
	conn3.close 
...
%>
<tr>
<td align="center" colspan="2"><input class="botonGrande" type="file" id="fileFotografia" name="fileFotografia" ENCTYPE="multipart/form-data" style="display:none" accept="image/*" capture/></td>
</tr>
        </table>
