...
<thead><tr><th>&nbsp;</th><th>CR</th><th>Suc.</th><th>Contrat.</th><th>Superv.</th><th>Fecha Inicio</th><th>Fecha Fin</th><th>Fecha Reprog.</th><th>Estatus</th><th>% Avance</th><%if cpsp="1" then%><th>Pend.</th><%else%><th>Costo Estimado</th><%end if%></tr></thead>
<tbody>
<%
