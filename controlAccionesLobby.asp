...
<div id="pagina">
  <div id="header">
   ...
   <table width="40%">
     <tr>
     <td width="10%">&nbsp;</td>
       <td width="20%"><a href="modalTest_sucursalesAsignadasContratistaAdmin_lobby.asp" target = "contenido" style="text-decoration:none"><input  type="button" value="Revisar Avances"  name="btnEnviar" /></a></td>
        <td width="10%">&nbsp;</td>
        <td width="20%"><a href="controlAcciones_asignarObraLobby.asp" target = "contenido" style="text-decoration:none"><input  type="button" value="Administrar"  name="btnEnviar" /></a></td>
         <td width="10%">&nbsp;</td>
        <td width="20%"><a href="RAO.asp" target = "contenido" style="text-decoration:none"><input  type="button" value="RAO"  name="btnEnviar" /></a></td>
      <td width="10%">&nbsp;</td>
     </tr>
    </table> 
  </div>   
