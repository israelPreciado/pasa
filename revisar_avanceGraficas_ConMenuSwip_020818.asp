...
'sql1="SELECT * FROM( SELECT 'Programado' AS Terminos_obra, enero.total AS enero, febrero.total AS febrero, marzo.total AS marzo, abril.total AS abril, mayo.total AS mayo, junio.total AS junio, julio.total AS julio, agosto.total AS agosto, septiembre.total AS septiembre, octubre.total AS octubre, noviembre.total AS noviembre, diciembre.total AS diciembre, enero.total + febrero.total + marzo.total + abril.total + mayo.total + junio.total + julio.total + agosto.total + septiembre.total + octubre.total + noviembre.total + diciembre.total AS Total FROM( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-01-01' AND '2018-01-31' AND b.zona_territorial = " & session.contents("zonaDirector") & ") AS enero LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-02-01' AND '2018-02-28' AND b.zona_territorial = " &  session.contents("zonaDirector") & ") AS febrero ON enero.tem = febrero.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-03-01' AND '2018-03-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS marzo ON enero.tem = marzo.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-04-01' AND '2018-04-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS abril ON enero.tem = abril.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-05-01' AND '2018-05-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS mayo ON enero.tem = mayo.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-06-01' AND '2018-06-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS junio ON enero.tem = junio.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-07-01' AND '2018-07-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS julio ON enero.tem = julio.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-08-01' AND '2018-08-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS agosto ON enero.tem = agosto.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-09-01' AND '2018-09-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS septiembre ON enero.tem = septiembre.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-10-01' AND '2018-10-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS octubre ON enero.tem = octubre.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-11-01' AND '2018-12-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS noviembre ON enero.tem = noviembre.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-12-01' AND '2018-12-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS diciembre ON enero.tem = diciembre.tem) programado UNION( SELECT 'Real' AS Terminos_obra, enero.total AS enero, febrero.total AS febrero, marzo.total AS marzo, abril.total AS abril, mayo.total AS mayo, junio.total AS junio, julio.total AS julio, agosto.total AS agosto, septiembre.total AS septiembre, octubre.total AS octubre, noviembre.total AS noviembre, diciembre.total AS diciembre, enero.total + febrero.total + marzo.total + abril.total + mayo.total + junio.total + julio.total + agosto.total + septiembre.total + octubre.total + noviembre.total + diciembre.total AS Total FROM( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-01-01' AND '2018-01-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS enero LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-02-01' AND '2018-02-28' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS febrero ON enero.tem = febrero.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-03-01' AND '2018-03-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS marzo ON enero.tem = marzo.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-04-01' AND '2018-04-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS abril ON enero.tem = abril.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-05-01' AND '2018-05-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS mayo ON enero.tem = mayo.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-06-01' AND '2018-06-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS junio ON enero.tem = junio.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-07-01' AND '2018-07-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS julio ON enero.tem = julio.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-08-01' AND '2018-08-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS agosto ON enero.tem = agosto.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-09-01' AND '2018-09-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS septiembre ON enero.tem = septiembre.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-10-01' AND '2018-10-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS octubre ON enero.tem = octubre.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-11-01' AND '2018-12-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS noviembre ON enero.tem = noviembre.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-12-01' AND '2018-12-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS diciembre ON enero.tem = diciembre.tem) UNION( SELECT '%Avance' AS Terminos_obra, enero.total AS enero, febrero.total AS febrero, marzo.total AS marzo, abril.total AS abril, mayo.total AS mayo, junio.total AS junio, julio.total AS julio, agosto.total AS agosto, septiembre.total AS septiembre, octubre.total AS octubre, noviembre.total AS noviembre, diciembre.total AS diciembre, enero.total + febrero.total + marzo.total + abril.total + mayo.total + junio.total + julio.total + agosto.total + septiembre.total + octubre.total + noviembre.total + diciembre.total AS Total FROM( SELECT 1 AS tem, CASE WHEN reales.total / programadas.total IS NULL THEN 0 ELSE reales.total / programadas.total END AS total FROM( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-01-01' AND '2018-01-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS reales LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-01-01' AND '2018-01-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS programadas ON programadas.tem = reales.tem) AS enero LEFT JOIN( SELECT 1 AS tem, CASE WHEN reales.total / programadas.total IS NULL THEN 0 ELSE reales.total / programadas.total END AS total FROM( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-02-01' AND '2018-02-28' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS reales LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-02-01' AND '2018-02-28' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS programadas ON programadas.tem = reales.tem) AS febrero ON enero.tem = febrero.tem LEFT JOIN( SELECT 1 AS tem, CASE WHEN reales.total / programadas.total IS NULL THEN 0 ELSE reales.total / programadas.total END AS total FROM( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-03-01' AND '2018-03-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS reales LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-03-01' AND '2018-03-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS programadas ON programadas.tem = reales.tem) AS marzo ON enero.tem = marzo.tem LEFT JOIN( SELECT 1 AS tem, CASE WHEN reales.total / programadas.total IS NULL THEN 0 ELSE reales.total / programadas.total END AS total FROM( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-04-01' AND '2018-04-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS reales LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-04-01' AND '2018-04-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS programadas ON programadas.tem = reales.tem) AS abril ON enero.tem = abril.tem LEFT JOIN( SELECT 1 AS tem, CASE WHEN reales.total / programadas.total IS NULL THEN 0 ELSE reales.total / programadas.total END AS total FROM( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-05-01' AND '2018-05-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS reales LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-05-01' AND '2018-05-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS programadas ON programadas.tem = reales.tem) AS mayo ON enero.tem = mayo.tem LEFT JOIN( SELECT 1 AS tem, CASE WHEN reales.total / programadas.total IS NULL THEN 0 ELSE reales.total / programadas.total END AS total FROM( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-06-01' AND '2018-06-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS reales LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-06-01' AND '2018-06-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS programadas ON programadas.tem = reales.tem) AS junio ON enero.tem = junio.tem LEFT JOIN( SELECT 1 AS tem, CASE WHEN reales.total / programadas.total IS NULL THEN 0 ELSE reales.total / programadas.total END AS total FROM( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-07-01' AND '2018-07-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS reales LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-07-01' AND '2018-07-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS programadas ON programadas.tem = reales.tem) AS julio ON enero.tem = julio.tem LEFT JOIN( SELECT 1 AS tem, CASE WHEN reales.total / programadas.total IS NULL THEN 0 ELSE reales.total / programadas.total END AS total FROM( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-08-01' AND '2018-08-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS reales LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-08-01' AND '2018-08-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS programadas ON programadas.tem = reales.tem) AS agosto ON enero.tem = agosto.tem LEFT JOIN( SELECT 1 AS tem, CASE WHEN reales.total / programadas.total IS NULL THEN 0 ELSE reales.total / programadas.total END AS total FROM( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-09-01' AND '2018-09-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS reales LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-09-01' AND '2018-09-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS programadas ON programadas.tem = reales.tem) AS septiembre ON enero.tem = septiembre.tem LEFT JOIN( SELECT 1 AS tem, CASE WHEN reales.total / programadas.total IS NULL THEN 0 ELSE reales.total / programadas.total END AS total FROM( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-10-01' AND '2018-10-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS reales LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-10-01' AND '2018-10-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS programadas ON programadas.tem = reales.tem) AS octubre ON enero.tem = octubre.tem LEFT JOIN( SELECT 1 AS tem, CASE WHEN reales.total / programadas.total IS NULL THEN 0 ELSE reales.total / programadas.total END AS total FROM( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-11-01' AND '2018-11-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS reales LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-11-01' AND '2018-11-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS programadas ON programadas.tem = reales.tem) AS noviembre ON enero.tem = noviembre.tem LEFT JOIN( SELECT 1 AS tem, CASE WHEN reales.total / programadas.total IS NULL THEN 0 ELSE reales.total / programadas.total END AS total FROM( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-12-01' AND '2018-12-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS reales LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-12-01' AND '2018-12-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS programadas ON programadas.tem = reales.tem) AS diciembre ON enero.tem = diciembre.tem) UNION( SELECT 'Programado Acumulado' AS Terminos_obra, enero.total AS enero, enero.total + febrero.total AS febrero, enero.total + febrero.total + marzo.total AS marzo, enero.total + febrero.total + marzo.total + abril.total AS abril, enero.total + febrero.total + marzo.total + abril.total + mayo.total AS mayo, enero.total + febrero.total + marzo.total + abril.total + mayo.total + junio.total AS junio, enero.total + febrero.total + marzo.total + abril.total + mayo.total + junio.total + julio.total AS julio, enero.total + febrero.total + marzo.total + abril.total + mayo.total + junio.total + julio.total + agosto.total AS agosto, enero.total + febrero.total + marzo.total + abril.total + mayo.total + junio.total + julio.total + agosto.total + septiembre.total AS septiembre, enero.total + febrero.total + marzo.total + abril.total + mayo.total + junio.total + julio.total + agosto.total + septiembre.total + octubre.total AS octubre, enero.total + febrero.total + marzo.total + abril.total + mayo.total + junio.total + julio.total + agosto.total + septiembre.total + octubre.total + noviembre.total AS noviembre, enero.total + febrero.total + marzo.total + abril.total + mayo.total + junio.total + julio.total + agosto.total + septiembre.total + octubre.total + noviembre.total + diciembre.total AS diciembre, enero.total + febrero.total + marzo.total + abril.total + mayo.total + junio.total + julio.total + agosto.total + septiembre.total + octubre.total + noviembre.total + diciembre.total AS Total FROM( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-01-01' AND '2018-01-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS enero LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-02-01' AND '2018-02-28' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS febrero ON enero.tem = febrero.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-03-01' AND '2018-03-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS marzo ON enero.tem = marzo.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-04-01' AND '2018-04-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS abril ON enero.tem = abril.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-05-01' AND '2018-05-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS mayo ON enero.tem = mayo.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-06-01' AND '2018-06-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS junio ON enero.tem = junio.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-07-01' AND '2018-07-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS julio ON enero.tem = julio.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-08-01' AND '2018-08-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS agosto ON enero.tem = agosto.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-09-01' AND '2018-09-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS septiembre ON enero.tem = septiembre.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-10-01' AND '2018-10-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS octubre ON enero.tem = octubre.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-11-01' AND '2018-12-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS noviembre ON enero.tem = noviembre.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE FechaTermino BETWEEN '2018-12-01' AND '2018-12-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & ") AS diciembre ON enero.tem = diciembre.tem) UNION( SELECT 'Real Acumulado' AS Terminos_obra, enero.total AS enero, enero.total + febrero.total AS febrero, enero.total + febrero.total + marzo.total AS marzo, enero.total + febrero.total + marzo.total + abril.total AS abril, enero.total + febrero.total + marzo.total + abril.total + mayo.total AS mayo, enero.total + febrero.total + marzo.total + abril.total + mayo.total + junio.total AS junio, enero.total + febrero.total + marzo.total + abril.total + mayo.total + junio.total + julio.total AS julio, enero.total + febrero.total + marzo.total + abril.total + mayo.total + junio.total + julio.total + agosto.total AS agosto, enero.total + febrero.total + marzo.total + abril.total + mayo.total + junio.total + julio.total + agosto.total + septiembre.total AS septiembre, enero.total + febrero.total + marzo.total + abril.total + mayo.total + junio.total + julio.total + agosto.total + septiembre.total + octubre.total AS octubre, enero.total + febrero.total + marzo.total + abril.total + mayo.total + junio.total + julio.total + agosto.total + septiembre.total + octubre.total + noviembre.total AS noviembre, enero.total + febrero.total + marzo.total + abril.total + mayo.total + junio.total + julio.total + agosto.total + septiembre.total + octubre.total + noviembre.total + diciembre.total AS diciembre, enero.total + febrero.total + marzo.total + abril.total + mayo.total + junio.total + julio.total + agosto.total + septiembre.total + octubre.total + noviembre.total + diciembre.total AS Total FROM( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-01-01' AND '2018-01-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS enero LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-02-01' AND '2018-02-28' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS febrero ON enero.tem = febrero.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-03-01' AND '2018-03-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS marzo ON enero.tem = marzo.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-04-01' AND '2018-04-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS abril ON enero.tem = abril.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-05-01' AND '2018-05-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS mayo ON enero.tem = mayo.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-06-01' AND '2018-06-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS junio ON enero.tem = junio.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-07-01' AND '2018-07-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS julio ON enero.tem = julio.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-08-01' AND '2018-08-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS agosto ON enero.tem = agosto.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-09-01' AND '2018-09-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS septiembre ON enero.tem = septiembre.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-10-01' AND '2018-10-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS octubre ON enero.tem = octubre.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-11-01' AND '2018-12-30' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS noviembre ON enero.tem = noviembre.tem LEFT JOIN( SELECT 1 AS tem, count(*) AS total FROM tseguimiento a LEFT JOIN cat_sucursales b ON a.cr = b.cr WHERE fechaEntrega BETWEEN '2018-12-01' AND '2018-12-31' AND b.zona_territorial = " & SESSION.contents("zonaDirector") & " AND entregada = 1) AS diciembre ON enero.tem = diciembre.tem)"
...
if (cdbl(eneP)=0 and cdbl(eneR)=0) or cdbl(eneP)>cdbl(eneR) then
ene=0
else
ene=cdbl(eneR)/cdbl(eneP)
end if
if (cdbl(febP)=0 and cdbl(febR)=0) or cdbl(febP)>cdbl(febR) then
feb=0
else
feb=cdbl(febR)/cdbl(febP)
end if
if (cdbl(marP)=0 and cdbl(marR)=0) or cdbl(marP)>cdbl(marR) then
mar=0
else
mar=cdbl(marR)/cdbl(marP)
end if
if (cdbl(abrP)=0 and cdbl(abrR)=0) or cdbl(abrP)>cdbl(abrR) then
abr=0
else
abr=cdbl(abrR)/cdbl(abrP)
end if
if (cdbl(mayP)=0 and cdbl(mayR)=0) or cdbl(mayP)>cdbl(mayR) then
may=0
else
may=cdbl(mayR)/cdbl(mayP)
end if
if (cdbl(junP)=0 and cdbl(junR)=0) or cdbl(junP)>cdbl(junR) then
jun=0
else
jun=cdbl(junR)/cdbl(junP)
end if
if (cdbl(julP)=0 and cdbl(julR)=0) or cdbl(julP)>cdbl(julR) then
jul=0
else
jul=cdbl(julR)/cdbl(julP)
end if
if (cdbl(agoP)=0 and cdbl(agoR)=0) or cdbl(agoP)>cdbl(agoR) then
ago=0
else
ago=cdbl(agoR)/cdbl(agoP)
end if
if (cdbl(sepP)=0 and cdbl(sepR)=0) or cdbl(sepP)>cdbl(sepR) then
sep=0
else
sep=cdbl(sepR)/cdbl(sepP)
end if
if (cdbl(octP)=0 and cdbl(octR)=0) or cdbl(octP)>cdbl(octR) then
octu=0
else
octu=cdbl(octR)/cdbl(octP)
end if
if (cdbl(novP)=0 and cdbl(novR)=0) or cdbl(novP)>cdbl(novR) then
nov=0
else
nov=cdbl(novR)/cdbl(novP)
end if
if (cdbl(dicP)=0 and cdbl(dicR)=0) or cdbl(dicP)>cdbl(dicR) then
dic=0
else
dic=cdbl(dicR)/cdbl(dicP)
end if
total=ene+feb+mar+abr+may+jun+jul+ago+sep+octu+nov+dic
%> 
						<tr>
							<td align="left" style="cursor:pointer;border:hidden"  ><font color="#000000">%Acumulado</font></td>
							<td align='center' style='cursor:pointer;border:hidden'  ><%=ene%></td>
							<td a<td align='center' style='cursor:pointer;border:hidden'  ><%=feb%></td>
<td align='center' style='cursor:pointer;border:hidden'  ><%=mar%></td>
<td align='center' style='cursor:pointer;border:hidden'  ><%=abr%></td>
<td align='center' style='cursor:pointer;border:hidden'  ><%=may%></td>
<td align='center' style='cursor:pointer;border:hidden'  ><%=jun%></td>
<td align='center' style='cursor:pointer;border:hidden'  ><%=jul%></td>
<td align='center' style='cursor:pointer;border:hidden'  ><%=ago%></td>
<td align='center' style='cursor:pointer;border:hidden'  ><%=sep%></td>
<td align='center' style='cursor:pointer;border:hidden'  ><%=octu%></td>
<td align='center' style='cursor:pointer;border:hidden'  ><%=nov%></td>
<td align='center' style='cursor:pointer;border:hidden'  ><%=dic%></td>
<td align='center' style='cursor:pointer;border:hidden'  ><%=total%></td>
