...
function detSearchElementoCerrado(id){
	...
	success: function(response){ 
	if (response=="1") {
		alert('El elemento ya esta cerrado')	
	}
	else{
		verDetalle(id)
	}
...
function detCerrarConcepto(id){
	...
	var update=response
	//$("#dedede").html(response);
	if (update=="ok" || update=="okE"){
		alert('Elemento cerrado')	
		} 
		else{
		alert(update)	
		//detSearchCostoEstimadPorPartida()
...
sql4= "select id,CLAVE_SAP_CONCURSO,clave_sap_zona,descorta as descripcion_corta,deslarga as descripcion_larga,pu,cantidad,und,cantidad * pu as estimacion,componente,fecha_ingreso, avance,round(avanceContratista,2) as avanceContratista from nuevocosto_estimadoobra where componente = '" & componente &"' and cr='" & session.Contents("cr") &"' and avanceContratista is not null order by avance desc;"
else
if componente="ATMS" then
sql4= "select a.id,a.CLAVE_SAP_CONCURSO,a.clave_sap_zona,b.DESCRIPCION_CORTA,b.DESCRIPCION_LARGA,a.pu,a.cantidad,b.und,a.cantidad * a.pu as estimacion,a.componente,a.fecha_ingreso, avance,round(avanceContratista,2) as avanceContratista from nuevocosto_estimadoobra a LEFT JOIN cat_sap_atms_2017 b on a.CLAVE_SAP_CONCURSO=b.CLAVE_SAP_CONCURSO where a.componente = '" & componente &"' and cr='" & session.Contents("cr") &"' and avanceContratista is not null order by avance desc; "
else
sql4= "select a.id,a.CLAVE_SAP_CONCURSO,a.clave_sap_zona,b.DESCRIPCION_CORTA,b.DESCRIPCION_LARGA,a.pu,a.cantidad,b.und,a.cantidad * a.pu as estimacion,a.componente,a.fecha_ingreso, avance,round(avanceContratista,2) as avanceContratista from nuevocosto_estimadoobra a LEFT JOIN cat_sap_2017 b on a.CLAVE_SAP_CONCURSO=b.CLAVE_SAP_CONCURSO where a.componente = '" & componente &"' and cr='" & session.Contents("cr") &"' and avanceContratista is not null order by avance desc; "
end if
end if
...
%>
        ...
        <tr>
         ...
         <td width="20%"  align="center"><p style="font-size:1.5em"><%=rs3("clave_sap_concurso")%></p></td>
...
conn3.open connstr
if componente="otros" then
sql4= "select id,CLAVE_SAP_CONCURSO,clave_sap_zona,descorta as descripcion_corta,deslarga as descripcion_larga,pu,cantidad,und,cantidad * pu as estimacion,componente,fecha_ingreso, avance,case when avanceContratista is null then 0 else round(avanceContratista,2) end as avanceContratista from nuevocosto_estimadoobra where componente = '" & componente &"' and cr='" & session.Contents("cr") &"' order by avance desc;"
else
if componente="ATMS" then
sql4= "select a.id,a.CLAVE_SAP_CONCURSO,a.clave_sap_zona,b.DESCRIPCION_CORTA,b.DESCRIPCION_LARGA,a.pu,a.cantidad,b.und,a.cantidad * a.pu as estimacion,a.componente,a.fecha_ingreso, avance,case when avanceContratista is null then 0 else round(avanceContratista,2) end as avanceContratista  from nuevocosto_estimadoobra a LEFT JOIN cat_sap_atms_2017 b on a.CLAVE_SAP_CONCURSO=b.CLAVE_SAP_CONCURSO where a.componente = '" & componente &"' and cr='" & session.Contents("cr") &"' order by avance desc; "
else
sql4= "select a.id,a.CLAVE_SAP_CONCURSO,a.clave_sap_zona,b.DESCRIPCION_CORTA,b.DESCRIPCION_LARGA,a.pu,a.cantidad,b.und,a.cantidad * a.pu as estimacion,a.componente,a.fecha_ingreso, avance,case when avanceContratista is null then 0 else round(avanceContratista,2) end as avanceContratista  from nuevocosto_estimadoobra a LEFT JOIN cat_sap_2017 b on a.CLAVE_SAP_CONCURSO=b.CLAVE_SAP_CONCURSO where a.componente = '" & componente &"' and cr='" & session.Contents("cr") &"' order by avance desc; "
end if
end if
