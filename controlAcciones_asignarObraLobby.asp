...
function editarUsuarios(){
	document.getElementById('frm_revisarAvance').action="controlAcciones_adminUsuarios_lobby.asp"
	document.getElementById('frm_revisarAvance').submit()
	//cambiarClase2()	
}
function adminEstimaciones(){
	document.getElementById('frm_revisarAvance').action="controlAcciones_adminEstimaciones.asp"
	document.getElementById('frm_revisarAvance').submit()
	//cambiarClase2()	
}
function adminFotos(){
	document.getElementById('frm_revisarAvance').action="eliminafotos.asp"
	document.getElementById('frm_revisarAvance').submit()
	//cambiarClase2()	
}

function adminSucur(){
	document.getElementById('frm_revisarAvance').action="gestionsucursales_lobby.asp"
	document.getElementById('frm_revisarAvance').submit()
	//cambiarClase2()	
}

function adminsuministro(){
	document.getElementById('frm_revisarAvance').action="controlAcciones_suministros.asp"
	document.getElementById('frm_revisarAvance').submit()
	//cambiarClase2()	
}
...
function asignarObra(){
	document.getElementById('frm_revisarAvance').action="controlAcciones_adminLobby.asp"
	document.getElementById('frm_revisarAvance').submit()
	//cambiarClase2()	
}
function asignarGerente(){
	document.getElementById('frm_revisarAvance').action="controlAcciones_asignarGerente.asp"
	document.getElementById('frm_revisarAvance').submit()
	//cambiarClase2()	
}
	...
	<table width="40%" align="center" class="animated zoomIn">
     	...
     	<tr height="30%">
     		<td width="15%" height="53">&nbsp;</td>
      		<td width="55%"><input  type="button" value="Administrar Obra" onclick="asignarObra()" name="btnEnviar" /></td>
      		<td width="30%">&nbsp;</td>
     	</tr>
      <!--
		<tr height="30%">
     		<td width="15%" height="53">&nbsp;</td>
      		<td width="55%"><input  type="button" value="Administrar Estimaciones" onclick="adminEstimaciones()" name="btnEnviar" /></td>
      		<td width="30%">&nbsp;</td>
     	</tr>
		<tr height="30%">
     		<td width="15%" height="53">&nbsp;</td>
      		<td width="55%"><input  type="button" value="Administrar Fotografias" onclick="adminFotos()" name="btnEnviar" /></td>
      		<td width="30%">&nbsp;</td>
     	</tr>
    
		<tr height="30%">
     		<td width="15%" height="53">&nbsp;</td>
      		<td width="55%"><input  type="button" value="Eliminar Lobby" onclick="adminSucur()" name="btnEnviar" /></td>
      		<td width="30%">&nbsp;</td>
     	</tr>
     
		<tr height="30%">
     		<td width="15%" height="53">&nbsp;</td>
      		<td width="55%"><input  type="button" value="Administrar Suministro" onclick="adminsuministro()" name="btnEnviar" /></td>
      		<td width="30%">&nbsp;</td>
     	</tr>
      -->
        <tr height="30%">
     		<td width="15%" height="53">&nbsp;</td>
      		<td width="55%"><input  type="button" value="Control de Usuarios" onclick="editarUsuarios()" name="btnEnviar" /></td>
      		<td width="30%">&nbsp;</td>
     	</tr>
      <!--
		<tr height="30%">
     		<td width="15%" height="53">&nbsp;</td>
      		<td width="55%"><input  type="button" value="Subir Archivo" onclick="subirArchivo()" name="btnEnviar" /></td>
      		<td width="30%">&nbsp;</td>
     	</tr>
      -->
    </table>
