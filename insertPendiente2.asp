...
sql="insert into pendientes (cr,pendiente,id_modulo,id_contratista,id_estatus,fecha_reporte,registradoPor,perfilRegistradoPor) values ('" & cr & "','" & pendiente & "'," & id_modulo & "," & id_contratista & ",1,'" & fecha &"','" & session.contents("id") & "','" & session.contents("privilegio") & "')"
